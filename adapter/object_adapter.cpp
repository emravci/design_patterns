...
{
	public:
	Rectangle(double side, double other_side) : rectangle_{side, other_side} {}
	virtual double area() const override { return ReadOnly::area(rectangle_); }
	private:
	ReadOnly::Rectangle rectangle_;
};
